...
client = MongoClient(uri) # Por defecto se conecta al localhost, hay que llamar a la I del host. (mejor dockerizar todo)
...
producer = KafkaProducer(bootstrap_servers=['kafka:9092'],api_version=(0,10)) # esto ha sido modificado para acceder al contenedor kafka
